    ...
    <ul class="sidebar-menu"> 
      ...
      <li class="treeview">
        ...
        <ul class="treeview-menu">                
          ...
          <li>
            <li><a href="index.php?c=Persona"><i class="fa fa-circle-o" aria-hidden="true"></i> Curso</a></li>
          </li>
          <li>
            <li><a href="index.php?c=Persona"><i class="fa fa-circle-o" aria-hidden="true"></i> Alumno</a></li>
          </li>
          <li>
            <li><a href="index.php?c=Persona"><i class="fa fa-circle-o" aria-hidden="true"></i> Universidad</a></li>
          </li>
        </ul>
      </li>
    </ul>
