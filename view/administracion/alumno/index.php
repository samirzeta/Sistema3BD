	    		 ...
	    		 <?php  $alumnos = $this->Listar();  ?>
                  	<table id="TablaEntidad" class="table table-bordered table-hover dataTable no-footer" width="100%">
	                    <thead>
	                      	<tr>                      
		                    	<th>ID</th>                    
			                    <th style="vertical-align: middle;">Nombre y Apellidos</th>
	                    ...
	                    <tbody>
	                    	...
	                    	<tr>
	                    		...
	                    		<td><?php echo ucwords(strtolower($alumno['primer_nombre'])).' '.$alumno['apellido_paterno'].' '.$alumno['apellido_materno']; ?></td>
                            	...
                            	<td class="a_center">                            		
                            		<a href="?c=Alumno&a=v_Actualizar&idAlumno=<?php echo $alumno['idAlumno']; ?>" class="btn btn-primary btn-xs " data-toggle="tooltip" data-placement="top" title="Actualizar">
                               		...
                               		<a class="btn btn-danger btn-xs EliminarAlumno" data-id="<?php echo $alumno['idAlumno']; ?>" data-alumno="<?php echo $alumno['primer_nombre'].' '.$alumno['apellido_paterno'].' '.$alumno['apellido_materno']; ?>" data-toggle="tooltip" data-placement="top" title="Eliminar">
