...
class AlumnoModel 
{
 ...
 private $bd;
    ...
    public function Actualizar(Alumno $alumno)
    {
        ...
        $this->bd = new Conexion();
        $stmt = $this->bd->prepare("UPDATE alumno SET  primer_nombre=:primer_nombre,apellido_paterno=:apellido_paterno,apellido_materno=:apellido_materno,edad=:edad,dni=:dni,fecha_nacimiento=:fecha_nacimiento,curso=:curso,carrera=:carrera,modificado_por=:modificado_por,activo=:activo WHERE idAlumno=:idAlumno;");
